...
<head>
    ...
    <title>SocialForum Admin Login</title>
    <!-- Styles -->
...
<body style="background-image: url(/image/adminback.jpg)";> 
    ...
    <span style="float:left; margin:10px"><i class="fa fa-copyright" aria-hidden="true"></i>© Copyright 2019 Developed by All rights reserved </span>
    </div>
