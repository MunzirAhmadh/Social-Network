        ...
        <div id="profile">
            <div class="wrap">
                ...
                <div id="expanded">
                    ...
                    <input name="twitter" type="text" value="input url for facebook" />
                    <label for="twitter"><i class="fa fa-twitter fa-fw" aria-hidden="true"></i></label>
                    <input name="twitter" type="text" value="input url for twiiter" />
                    <label for="insta"><i class="fa fa-instagram fa-fw" aria-hidden="true"></i></label>
                    <input name="insta" type="text" value="input url for instagram" />
                </div>
            </div>
        </div>
        <div id="search">
